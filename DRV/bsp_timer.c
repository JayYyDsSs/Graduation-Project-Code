...
void Timer6_Init(void)
{
	...
	TIM_TimeBaseStructure.TIM_Period = 4999;//自动重新装载寄存器周期的值澹ㄥ计数值澹)/9999是100ms
...
//***************************定时器2初始化 ，使用编码器功能***************************//
//左电机编码器计数
//PB3----接编码器A相或者电机驱动的B1A标识
//PA15----接编码器B相或者电机驱动的B1B标识
...
//***************************定时器3初始化 ，使用编码器功能***************************//
//左电机编码器计数
//PB4----接编码器A相或者电机驱动的B2B标识
//PB5----接编码器B相或者电机驱动的B2A标识
...
//***************************定时器4初始化 ，使用编码器功能***************************//
//复用TIM4
//PB6----接编码器A相或者电机驱动的B1A标识
//PB7----接编码器B相或者电机驱动的B1B标识
...
//***************************A轮 定时器5初始化 ，使用编码器功能***************************//
//复用TIM5
//PA0----接编码器A相或者电机驱动的B2A标识
//PA1----接编码器B相或者电机驱动的B2B标识
